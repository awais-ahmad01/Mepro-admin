...
export default function Rewards() {
  ...
  const handleFormSave = () => {
    ...
    if (!form.points.toString().trim()) error.points = "Point cost is required.";
      ...
      {showForm ? (
        ...
        >
          ...
          <Box display="grid" gridTemplateColumns="1fr 1fr" gap={4}>
            ...
            <Box>
              ...
              <Select
                ...
                renderValue={(selected) => {
                  if (!selected) {
                    return <Typography sx={{ color: '#FF4D7D', opacity: 1, fontSize: 20 }}>-------</Typography>;
                  }
            ...
            <Box>
              <Typography fontSize={18} mb={1.5}>Expiration Date <span style={{color: '#FF4D7D'}}>*</span></Typography>
