...
// // import { format, addDays, addWeeks, addYears, parseISO, differenceInWeeks } from 'date-fns';
...
// //   Complete: { bg: string; color: string };
// //   Cancelled: { bg: string; color: string };
// //   [key: string]: { bg: string; color: string }; // Add index signature
// // }
...
// //   free: { amount: 5, type: 'one-time', duration: 0, weeks: 0 },
// //   diamond: { amount: 2, type: 'weekly', duration: 1, weeks: 52 },
// //   vip: { amount: 3, type: 'weekly', duration: 2, weeks: 104 },
// //   'free-to-diamond': { amount: 1.5, type: 'weekly', duration: 1, weeks: 52 },
// //   'free-to-vip': { amount: 2.5, type: 'weekly', duration: 2, weeks: 104 },
// //   'diamond-to-vip': { amount: 1.5, type: 'weekly', duration: 2, weeks: 104 },
// // };
...
// //     salesRepId: 'SR002',
// //     pricePlan: 'Free',
// //     merchantStartDate: '2024-10-01',
// //     initialPayoutDate: '2024-10-15',
// //     weeklyPayment: 5.00,
// //     commissionEndDate: '2024-10-15',
// //     status: 'Complete',
// //     weeksRemaining: 0,
// //     totalPaid: 5.00,
// //     nextPaymentDate: '-',
...
// //   {
// //     id: 'M004',
// //     merchantName: 'Thai Spa & Wellness',
// //     salesRep: 'Sarah Wilson',
// //     salesRepId: 'SR002',
// //     pricePlan: 'VIP',
// //     merchantStartDate: '2023-12-01',
// //     initialPayoutDate: '2023-12-15',
// //     weeklyPayment: 3.00,
// //     commissionEndDate: '2025-12-01',
// //     status: 'Active',
// //     weeksRemaining: 56,
// //     totalPaid: 1440.00,
// //     nextPaymentDate: '2024-11-15',
...
// //   {
// //     id: 'M005',
// //     merchantName: 'Burger Hub Express',
// //     salesRep: 'Michael Brown',
// //     salesRepId: 'SR003',
// //     pricePlan: 'Diamond',
// //     merchantStartDate: '2024-09-01',
// //     initialPayoutDate: '2024-09-15',
// //     weeklyPayment: 2.00,
// //     commissionEndDate: '2025-09-01',
// //     status: 'Pending',
// //     weeksRemaining: 43,
// //     totalPaid: 0.00,
// //     nextPaymentDate: '2024-11-15',
...
// //   const totalWeeklyCommission = salesReps.reduce((sum, rep) => sum + rep.weeklyCommission, 0);
// //   const totalActiveMerchants = salesReps.reduce((sum, rep) => sum + rep.activeMerchants, 0);
// //   const totalSalesReps = salesReps.length;
// //   const pendingApprovals = upcomingPayouts.filter(p => p.status === 'Pending Approval').length;
...
// //               fontWeight: 500,
// //               fontSize: 16,
// //               color: activeTab === 0 ? '#FF4D7D' : '#718EBF',
...
// //               fontWeight: 500,
// //               fontSize: 16,
// //               color: activeTab === 1 ? '#FF4D7D' : '#718EBF',
// //               '&.Mui-selected': { color: '#FF4D7D' },
// //             }}
// //           />
// //           <Tab
...
// //               fontWeight: 500,
// //               fontSize: 16,
// //               color: activeTab === 2 ? '#FF4D7D' : '#718EBF',
// //               '&.Mui-selected': { color: '#FF4D7D' },
// //             }}
// //           />
// //           <Tab
...
// //               fontWeight: 500,
// //               fontSize: 16,
// //               color: activeTab === 3 ? '#FF4D7D' : '#718EBF',
// //               '&.Mui-selected': { color: '#FF4D7D' },
// //             }}
// //           />
// //         </Tabs>
...
// //                 </TableHead>
// //                 <TableBody>
// //                   {merchantCommissions.map((commission) => (
...
// //                           size="small"
// //                           sx={{
// //                             bgcolor: statusColors[commission.status]?.bg,
// //                             color: statusColors[commission.status]?.color,
// //                             fontWeight: 500,
// //                           }}
// //                         />
// //                       </TableCell>
...
// //                 <TableBody>
// //                   {salesReps.map((rep) => (
// //                     <TableRow key={rep.id} sx={{ '&:hover': { bgcolor: '#f9fafb' } }}>
...
// //                   <TableBody>
// //                     <TableRow>
// //                       <TableCell sx={{ fontWeight: 600 }}>New Free Merchant</TableCell>
// //                       <TableCell>£0</TableCell>
// //                       <TableCell sx={{ fontWeight: 600, color: '#039855' }}>£5.00 (One-time bonus)</TableCell>
// //                       <TableCell>Once</TableCell>
// //                       <TableCell>14 days</TableCell>
// //                     </TableRow>
// //                     <TableRow>
// //                       <TableCell sx={{ fontWeight: 600 }}>New Diamond Merchant</TableCell>
// //                       <TableCell>£45</TableCell>
// //                       <TableCell sx={{ fontWeight: 600, color: '#B54708' }}>£2.00 per week</TableCell>
// //                       <TableCell>1 year (52 weeks)</TableCell>
// //                       <TableCell>14 days</TableCell>
// //                     </TableRow>
// //                     <TableRow>
// //                       <TableCell sx={{ fontWeight: 600 }}>New VIP Merchant</TableCell>
// //                       <TableCell>£120</TableCell>
// //                       <TableCell sx={{ fontWeight: 600, color: '#6941C6' }}>£3.00 per week</TableCell>
// //                       <TableCell>2 years (104 weeks)</TableCell>
// //                       <TableCell>14 days</TableCell>
// //                     </TableRow>
// //                     <TableRow>
// //                       <TableCell sx={{ fontWeight: 600 }}>Upgrade: Free → Diamond</TableCell>
// //                       <TableCell>£45</TableCell>
// //                       <TableCell sx={{ fontWeight: 600, color: '#B54708' }}>£1.50 per week</TableCell>
// //                       <TableCell>1 year (52 weeks)</TableCell>
// //                       <TableCell>14 days</TableCell>
// //                     </TableRow>
// //                     <TableRow>
// //                       <TableCell sx={{ fontWeight: 600 }}>Upgrade: Free → VIP</TableCell>
// //                       <TableCell>£120</TableCell>
// //                       <TableCell sx={{ fontWeight: 600, color: '#6941C6' }}>£2.50 per week</TableCell>
// //                       <TableCell>2 years (104 weeks)</TableCell>
// //                       <TableCell>14 days</TableCell>
// //                     </TableRow>
// //                     <TableRow>
// //                       <TableCell sx={{ fontWeight: 600 }}>Upgrade: Diamond → VIP</TableCell>
// //                       <TableCell>£120</TableCell>
// //                       <TableCell sx={{ fontWeight: 600, color: '#6941C6' }}>£1.50 per week</TableCell>
// //                       <TableCell>Extends Diamond payment for an extra year (up to 2 years total)</TableCell>
// //                       <TableCell>14 days</TableCell>
// //                     </TableRow>
// //                   </TableBody>
// //                 </Table>
...
// //         <DialogTitle sx={{ fontWeight: 600, fontSize: 20 }}>Approve Commission Payment</DialogTitle>
// //         <DialogContent>
// //           {selectedPayout && (
// //             <Box sx={{ pt: 2 }}>
// //               <Alert severity="warning" sx={{ mb: 3 }}>
// //                 Please review the payment details carefully before approving.
// //               </Alert>
